...
import com.example.BootcampMsMobileApp.util.MessageSerializer;
...
public class KafkaProducerConfig {
	...
	@Bean
	public KafkaTemplate<String, MessageDto> kafkaTempalte(ProducerFactory<String, MessageDto> producerFactory){
